...
export function HomeClient() {
  return (
    <main className="flex min-h-dvh w-full flex-col items-center justify-between overflow-x-hidden text-foreground selection:bg-primary selection:text-primary-foreground">
